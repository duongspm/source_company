                ...
                <div class="card card-primary card-outline text-sm">
                    ...
                    <div class="card-body">
                        <?php
                            $photoDetail = array();
                            $photoDetail['upload'] = UPLOAD_PRODUCT_L;
                            $photoDetail['image'] = (!empty($item)) ? $item['photo2'] : '';
                            $photoDetail['dimension'] = "Width2: " . $config['product'][$type]['width2'] . " px - Height2: " . $config['product'][$type]['height2'] . " px (" . $config['product'][$type]['img_type'] . ")";
                        ?>
