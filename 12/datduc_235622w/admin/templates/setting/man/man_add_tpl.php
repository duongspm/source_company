        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                <div class="form-group">
                    <button type="button" class="btn btn-database bg-gradient-warning" data-action="ANALYZE"><i
                            class="fas fa-database mr-2"></i>Analyze</button>
                    <button type="button" class="btn btn-database bg-gradient-success" data-action="OPTIMIZE"><i
                            class="fas fa-magic mr-2"></i>Optimize</button>
                    <button type="button" class="btn btn-database bg-gradient-info" data-action="CHECK"><i
                            class="fas fa-tasks mr-2"></i>Check</button>
                    <button type="button" class="btn btn-database bg-gradient-primary" data-action="REPAIR"><i
                            class="fas fa-tools mr-2"></i>Repair</button>
                </div>
                ...
                <div
                    ...
                    <div class="row">
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control text-sm" name="data[options][ip_host]" id="ip_host"
                                placeholder="Host" value="<?= $options['ip_host'] ?>">
                        </div>
                        <div class="form-group col-md-4 col-sm-6">
                        ...
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control text-sm" name="data[options][password_host]"
                                id="password_host" placeholder="Password host" value="<?= $options['password_host'] ?>">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <select class="custom-select text-sm" name="data[options][secure_gmail]" id="secure_gmail">
                                <option <?= ($options['secure_gmail'] == 'tls') ? 'selected' : '' ?> value="tls">TLS
                                </option>
                                <option <?= ($options['secure_gmail'] == 'ssl') ? 'selected' : '' ?> value="ssl">SSL
                                </option>
                            </select>
                        </div>
                        <div class="form-group col-md-4 col-sm-6">
                        ...
                        <div class="form-group col-md-4 col-sm-6">
                            ...
                            <input type="text" class="form-control text-sm" name="data[options][password_gmail]"
                                id="password_gmail" placeholder="Password" value="<?= $options['password_gmail'] ?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio d-inline-block mr-3 text-md">
                            <input class="custom-control-input" type="radio" id="lang_default-<?= $k ?>"
                                name="data[options][lang_default]"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control text-sm" name="data[options][oaidzalo]" id="oaidzalo"
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" class="form-control text-sm" name="data[options][coords]" id="coords"
                            placeholder="Tọa độ google map"
                            value="<?= (!empty($flash->has('coords'))) ? $flash->get('coords') : @$options['coords'] ?>">
                    </div>
                    <?php } ?>
                </div>
                <!-- <?php if (isset($config['setting']['direct']) && $config['setting']['direct'] == true) { ?>
                <div class="form-group">
                    <label for="direct">
                        <span>Chỉ đường:</span>
                        <a class="text-sm font-weight-normal ml-1" href="https://www.google.com/maps" target="_blank"
                            title="Lấy link">(Lấy link)</a>
                    </label>
                    <textarea class="form-control" name="data[options][direct]" id="direct" rows="5"
                        placeholder="Chỉ đường"><?= htmlspecialchars_decode($options['direct']) ?></textarea>
                </div>
                <?php } ?> -->
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control text-sm" name="data[analytics]" id="analytics" rows="5"
                        placeholder="Google analytics"><?= htmlspecialchars_decode((!empty($flash->has('analytics'))) ? $flash->get('analytics') : @$item['analytics']) ?></textarea>
                </div>
                <div class="form-group">
                    <label for="mastertool">Google Webmaster Tool:</label>
                    <textarea class="form-control text-sm" name="data[mastertool]" id="mastertool" rows="5"
                        placeholder="Google Webmaster Tool"><?= htmlspecialchars_decode((!empty($flash->has('mastertool'))) ? $flash->get('mastertool') : @$item['mastertool']) ?></textarea>
                </div>
                <div class="form-group">
                    <label for="headjs">Head JS:</label>
                    <textarea class="form-control text-sm" name="data[headjs]" id="headjs" rows="5"
                        placeholder="Head JS"><?= htmlspecialchars_decode((!empty($flash->has('headjs'))) ? $flash->get('headjs') : @$item['headjs']) ?></textarea>
                </div>
                <div class="form-group">
                    <label for="bodyjs">Body JS:</label>
                    <textarea class="form-control text-sm" name="data[bodyjs]" id="bodyjs" rows="5"
                        placeholder="Body JS"><?= htmlspecialchars_decode((!empty($flash->has('bodyjs'))) ? $flash->get('bodyjs') : @$item['bodyjs']) ?></textarea>
                </div>
