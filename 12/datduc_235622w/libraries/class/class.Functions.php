...
'script' => '@<script[^>]*?>.*?</script>@si',
	...
	/* Build Schema */
	public function buildSchemaArticle($id_news, $name, $image, $date_created, $date_updated, $name_author, $url, $logo, $url_author)
	{
		$str = '{';
		...
		$str .= '"headline": "' . $name . '",';
		$str .= '"image":"' . $image . '",';
		$str .= '"datePublished": "' . date('c', $date_created) . '",';
		$str .= '"dateModified": "' . date('c', $date_updated) . '",';
		$str .= '"author":';
		$str .= '{';
		$str .= '"@type": "Person",';
