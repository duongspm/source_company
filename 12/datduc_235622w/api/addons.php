...
<div class="video-main">
    <iframe width="100%" height="100%"
        src="//www.youtube.com/embed/<?=$func->getYoutube($video_home[0]['link_video'])?>" frameborder="0"
...
<div class="fb-page" data-href="<?=$optsetting['fanpage']?>" data-tabs="timeline" data-width="600" data-height="300"
...
<div class="js-facebook-messenger-container">
    ...
    <div class="fb-page" data-href="<?=$optsetting['fanpage']?>" data-tabs="messages" data-small-header="true"
        data-height="315" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
